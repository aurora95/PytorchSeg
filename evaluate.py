...
def parse_args():
    ...
    parser.add_argument('--flip', action="store_true", dest='flip', help='flip or not', default=False)
...
def evaluate(net, args):
    ...
    inference(net, args, image_list, flip=args.flip, return_results=False, save_dir=save_dir)
